/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: c9e45d6eac1ba168ae0598a94b635413)
...
interface __BaseEnv_CloudflareBindings {
	...
	RPC_URL: string;
	TRANSACTION_TRACKER: Workflow /* TransactionTracker */;
}
