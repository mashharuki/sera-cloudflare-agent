/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 99d4c88d361e3701d9b8b8f29e62079e)
...
interface __BaseEnv_CloudflareBindings {
	...
	RPC_URL: string;
	TRANSACTION_TRACKER: Workflow<Parameters<import("./src/index").TransactionTracker['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STAGE" | "NETWORK" | "CHAIN_ID" | "MODEL_ID" | "SERA_NETWORK" | "ALLOWED_ORIGIN" | "PRIVY_APP_ID" | "PRIVY_APP_SECRET" | "GEMINI_API_KEY" | "RPC_URL">> {}
}
